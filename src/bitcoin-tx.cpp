...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " shiftcoins-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  shiftcoins-tx [options] <hex-tx> [commands]  Update hex-encoded shiftcoins transaction\n" +
            "or:     shiftcoins-tx [options] -create [commands]   Create hex-encoded shiftcoins transaction\n" +
            "\n";
