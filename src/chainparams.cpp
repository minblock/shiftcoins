...
{
    const char* pszTimestamp = "4/2/2020 Provigen Networks: Now accepting changedoshis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586054372, 251021, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xdf6119ab002da8caf88f78272ccba25d9e5750fb37bf1b05d0fdfe3d7655f8e9"));
        assert(genesis.hashMerkleRoot == uint256S("0xfde16b84d64b917c6bfea394ef39464db7dbc78760768ae99324f2762ef7eb1b"));
        ...
        vSeeds.emplace_back("seed-a.shiftcoins.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.shiftcoinstools.com");
        vSeeds.emplace_back("dnsseed.shiftcoinspool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1982285, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6ef43d7a8f5c8803d7bdf1a185025d3438b0976abfa6c71e8567e07b55c5777d"));
        assert(genesis.hashMerkleRoot == uint256S("0xfde16b84d64b917c6bfea394ef39464db7dbc78760768ae99324f2762ef7eb1b"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.shiftcoinstools.com");
        vSeeds.emplace_back("seed-b.shiftcoins.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x28344b0945bba832111a330f6b4941d18b6d3adf3708adf487e573e18dffcbfe"));
        assert(genesis.hashMerkleRoot == uint256S("0xfde16b84d64b917c6bfea394ef39464db7dbc78760768ae99324f2762ef7eb1b"));
