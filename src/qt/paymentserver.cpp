...
const QString BITCOIN_IPC_PREFIX("shiftcoins:");
#ifdef ENABLE_BIP70
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/shiftcoins-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/shiftcoins-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/shiftcoins-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start shiftcoins: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("shiftcoins://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'shiftcoins://' is not a valid URI. Use 'shiftcoins:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Shiftcoins address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
