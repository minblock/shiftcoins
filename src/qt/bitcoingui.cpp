...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Shiftcoins address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and shiftcoins: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Shiftcoins addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Shiftcoins addresses"));
    ...
    openAction->setStatusTip(tr("Open a shiftcoins: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Shiftcoins command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Shiftcoins network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Shiftcoins"); // default title
