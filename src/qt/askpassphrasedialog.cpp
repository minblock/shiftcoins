...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR SHIFTCOINSS</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         ...
                                         "your shiftcoinss from being stolen by malware infecting your computer.") +
                                         "<br><br><b>" +
