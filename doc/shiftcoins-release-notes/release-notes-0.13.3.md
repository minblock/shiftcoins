Shiftcoins Core version 0.13.3 is now available from:

  <https://download.shiftcoins.org/shiftcoins-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/shiftcoins-project/shiftcoins/blob/0.13/src/chainparams.cpp#L214).
