# Support for Output Descriptors in Shiftcoins Core

Since Shiftcoins Core v0.17, there is support for Output Descriptors. This is a
...
on Shiftcoins's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Shiftcoins Core wallets, a convenience function `combo` is
