...
By default, Shiftcoins Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that shiftcoins's trustless model works best if you are
