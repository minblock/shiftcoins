...
"""Shiftcoins P2P network half-a-node.
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        logger.debug('Connecting to Shiftcoins Node: %s:%d' % (self.dstaddr, self.dstport))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Shiftcoins node.
