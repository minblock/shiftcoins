...
class HTTPBasicsTest(BitcoinTestFramework):
    ...
    def setup_chain(self):
        ...
        with open(os.path.join(get_datadir_path(self.options.tmpdir, 0), "shiftcoins.conf"), 'a', encoding='utf8') as f:
            f.write(rpcauth+"\n")
            f.write(rpcauth2+"\n")
            f.write(rpcauth3+"\n")
        with open(os.path.join(get_datadir_path(self.options.tmpdir, 1), "shiftcoins.conf"), 'a', encoding='utf8') as f:
            f.write(rpcuser+"\n")
            f.write(rpcpassword+"\n")
