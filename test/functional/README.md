...
with the shiftcoinsd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a shiftcoinsd.  `P2PInterface`
contains the higher level logic for processing P2P payloads and connecting to
the Shiftcoins Core node application logic. For custom behaviour, subclass the
...
Basic code to support P2P connectivity to a shiftcoinsd.
