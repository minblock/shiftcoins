...
"""Verify that starting shiftcoins with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shiftcoins with -h for help text")
        ...
        self.log.info("Start shiftcoins with -version for version information")
        ...
        self.log.info("Start shiftcoinsd with -fakearg to make sure it does not start")
